...
interface BodyParamsProps {
    ...
    selected: string,
    endpoint8: string,
    setEndpoint8: React.Dispatch<React.SetStateAction<string>>,
    endpoint10: string,
    setEndpoint10: React.Dispatch<React.SetStateAction<string>>,
    endpoint3: string,
    setEndpoint3:  React.Dispatch<React.SetStateAction<string>>,
    endpoint: string,
    setEndpoint: React.Dispatch<React.SetStateAction<string>>,
    endpoint1: string,
    setEndpoint1: React.Dispatch<React.SetStateAction<string>>,
    endpoint2: string, 
    setEndpoint2: React.Dispatch<React.SetStateAction<string>>,
    endpoint4: string, 
    setEndpoint4: React.Dispatch<React.SetStateAction<string>>,
    endpoint5: string, 
    setEndpoint5: React.Dispatch<React.SetStateAction<string>>,
    endpoint6: string, 
    setEndpoint6: React.Dispatch<React.SetStateAction<string>>,
    endpoint7: string, 
    setEndpoint7: React.Dispatch<React.SetStateAction<string>>,
    endpoint9: string, 
    setEndpoint9: React.Dispatch<React.SetStateAction<string>>,
    endpoint11: string, 
    setEndpoint11: React.Dispatch<React.SetStateAction<string>>,
    endpoint12: string, 
    setEndpoint12: React.Dispatch<React.SetStateAction<string>>,
    endpoint13: string, 
    setEndpoint13: React.Dispatch<React.SetStateAction<string>>,
}

const BodyParams: React.FC<BodyParamsProps> = ({
    show2, 
    selected, 
    endpoint8, 
    setEndpoint8,
